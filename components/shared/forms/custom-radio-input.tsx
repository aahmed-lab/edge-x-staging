                     ...
                     {options.map((item, key) => (
                        <label
                           ...
                           <input
                              ...
                              className="checked:bg-white-dot form-radio border-accent-1 bg-transparent text-black focus:outline-none focus:ring  focus:ring-accent-1 focus:ring-opacity-50 focus:ring-offset-0 focus:ring-offset-transparent"
                              value={item.value}
