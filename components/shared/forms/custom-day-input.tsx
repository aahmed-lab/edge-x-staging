                     ...
                     <div className={classNames('relative flex')}>
                        ...
                        <input
                           ...
                           className={classNames(
                              ...
                              'custom-input block w-full border-accent-1 text-white  placeholder:text-[#7F8694] focus:border-accent-1 focus:outline-none focus:ring focus:ring-accent-1 focus:ring-opacity-50',
                           ...
                           <div
                              ...
                              className={classNames(
                                 ...
                                 error &&
                                    typeof error !== 'boolean' &&
                                    '!border-red-500 focus:border-red-500 focus:ring-red-500',
                                 'custom-input block w-full border-accent-1  text-black  focus:border-accent-1 focus:outline-none focus:ring focus:ring-accent-1 focus:ring-opacity-50',
                                 appendPaddingClass && `${appendPaddingClass}`,
                                 prependPaddingClass && `${prependPaddingClass}`,
                                 disabled &&
                                    'disabled:cursor-not-allowed disabled:bg-gray-200 disabled:opacity-50'
                              ...
                              <div className="col-6">
                                 <button
                                    ...
                                    className={classNames(
                                       ...
                                       'disabled:cursor-not-allowed disabled:opacity-50 ',
                                       'enabled:focus:ring-accent bg-secondary enabled:hover:bg-secondary-600 enabled:active:bg-secondary-600',
                                       ''
                                    )}>
